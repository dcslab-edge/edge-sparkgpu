...
# install aarch64 libs
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcublas-natives -Dversion=$version -Dclassifier=linux-aarch64 -Dfile=jcublas-natives-$version-linux-aarch64.jar -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcuda-natives -Dversion=$version -Dclassifier=linux-aarch64 -Dfile=jcuda-natives-$version-linux-aarch64.jar -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcufft-natives -Dversion=$version -Dclassifier=linux-aarch64 -Dfile=jcufft-natives-$version-linux-aarch64.jar -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcurand-natives -Dversion=$version -Dclassifier=linux-aarch64 -Dfile=jcurand-natives-$version-linux-aarch64.jar -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcusparse-natives -Dversion=$version -Dclassifier=linux-aarch64 -Dfile=jcusparse-natives-$version-linux-aarch64.jar -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcusolver-natives -Dversion=$version -Dclassifier=linux-aarch64 -Dfile=jcusolver-natives-$version-linux-aarch64.jar -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jcudnn-natives -Dversion=$version -Dclassifier=linux-aarch64 -Dfile=jcudnn-natives-$version-linux-aarch64.jar -Durl=file://.
mvn deploy:deploy-file -DgroupId=jcuda -DartifactId=jnvgraph-natives -Dversion=$cudnn_version -Dclassifier=linux-aarch64 -Dfile=jnvgraph-natives-$version-linux-aarch64.jar -Durl=file://.
